...
public:
  ...
  template<typename T>
  bool operator()(
    const T * const q_a_ptr, const T * const t_a_ptr,
...
public:
    ...
    T * residuals_ptr) const
  {
    ...
    Eigen::Quaternion<double> q_ab_measured_{rel_ab_measured_[3], rel_ab_measured_[0],
      rel_ab_measured_[1], rel_ab_measured_[2]};
    Eigen::Matrix<double, 3, 1> t_ab_measured_{rel_ab_measured_[4], rel_ab_measured_[5],
      rel_ab_measured_[6]};
